...
public class SqlServerGrpcEndToEndTest extends AbstractGrpcEndToEndTest {
    ...
    public static void setup() throws Exception {
        ...
        System.setProperty(GRPCServerConfiguration.PORT_PROPERTY_NAME, Integer.toString(SERVER_PORT));
        System.setProperty(ElasticSearchConfiguration.EMBEDDED_PORT_PROPERTY_NAME, "9212");
        System.setProperty(ElasticSearchConfiguration.ELASTIC_SEARCH_URL_PROPERTY_NAME, "localhost:9312");
