...
public class SqlServerMetadataDAO extends SqlServerBaseDAO implements MetadataDAO, EventHandlerDAO {
    ...
    private static final String className = SqlServerMetadataDAO.class.getSimpleName();
    
    public SqlServerMetadataDAO(ObjectMapper om, DataSource dataSource, SqlServerProperties properties) {
        super(om, dataSource);
