...
public class SqlServerMetadataDAOTest {

    private SqlServerDAOTestUtil testUtil;
    private SqlServerMetadataDAO dao;
    ...
    public void setup() throws Exception {
        ...
        dao = new SqlServerMetadataDAO(testUtil.getObjectMapper(), testUtil.getDataSource(), testUtil.getTestConfiguration());
    }
