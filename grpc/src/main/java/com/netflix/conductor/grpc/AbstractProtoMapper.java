...
public abstract class AbstractProtoMapper {
    ...
    public EventHandlerPb.EventHandler.Action.Type toProto(EventHandler.Action.Type from) {
        ...
        switch (from.getType()) {
            case EventHandler.Action.ActionType
                .START_WORKFLOW: to = EventHandlerPb.EventHandler.Action.Type.START_WORKFLOW; break;
            case EventHandler.Action.ActionType
                .COMPLETE_TASK: to = EventHandlerPb.EventHandler.Action.Type.COMPLETE_TASK; break;
            case EventHandler.Action.ActionType
                .FAIL_TASK: to = EventHandlerPb.EventHandler.Action.Type.FAIL_TASK; break;
            default: throw new IllegalArgumentException("Unexpected enum constant: " + from);
        }
        return to;
    }
