...
public abstract class SQLQueueDAOTest {

	private static final Logger LOGGER = LoggerFactory.getLogger(SQLQueueDAOTest.class);

	protected SqlDAOTestUtil testUtil;
