...
@Singleton
public abstract class SQLExecutionDAO extends SQLBaseDAO implements ExecutionDAO {

    private static final String ARCHIVED_FIELD = "archived";
    private static final String RAW_JSON_FIELD = "rawJSON";

    @Inject
    public SQLExecutionDAO(ObjectMapper objectMapper, DataSource dataSource) {
    ...
    protected abstract void addPendingWorkflow(Connection connection, String workflowType, String workflowId);
    ...
    protected abstract void insertOrUpdateTaskData(Connection connection, Task task);
    ...
    protected abstract void addWorkflowToTaskMapping(Connection connection, Task task);
    ...
    @VisibleForTesting
    protected abstract boolean addScheduledTask(Connection connection, Task task, String taskKey);
    ...
    protected abstract void insertOrUpdatePollData(Connection connection, PollData pollData, String domain);
