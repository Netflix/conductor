...
@Singleton
public abstract class SQLMetadataDAO extends SQLBaseDAO implements MetadataDAO {
    ...
    private static final String className = SQLMetadataDAO.class.getSimpleName();
    @Inject
    public SQLMetadataDAO(ObjectMapper om, DataSource dataSource, Configuration config) {
        super(om, dataSource);
