...
public class EventWait  extends WorkflowSystemTask{

    private static final Logger logger = LoggerFactory.getLogger(EventWait.class);
    public static final String NAME = "EVENT_WAIT";
    ...
    @Inject
    public EventWait(EventQueues eventQueues, ParametersUtils parametersUtils) {
        super(NAME);
