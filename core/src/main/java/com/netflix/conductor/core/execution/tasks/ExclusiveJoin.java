            ...
            if (defaultExclusiveJoinTasks != null && !defaultExclusiveJoinTasks.isEmpty()) {
                for (String defaultExclusiveJoinTask : defaultExclusiveJoinTasks) {
                    ...
                    if (exclusiveTask == null
                            || exclusiveTask.getStatus() == TaskStatusDO.SKIPPED) {
                        LOGGER.debug(
