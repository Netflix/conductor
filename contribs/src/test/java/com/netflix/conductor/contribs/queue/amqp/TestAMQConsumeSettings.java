 ...
 * @version $Id$
 */
public class TestAMQConsumeSettings {
    ...
    public void testQueueURIWithDefaultConfig() {
        ...
        final String queueURI = "amqp:myQueueName";
        AMQConsumeSettings settings = new AMQConsumeSettings(config);
        settings.fromURI(queueURI);
        assertEquals(AMQPublishSettings.DEFAULT_CONTENT_ENCODING, settings.getContentEncoding());
        assertEquals("myQueueName", settings.getQueueName());
