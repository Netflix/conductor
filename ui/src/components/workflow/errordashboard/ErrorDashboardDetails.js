 ...
 componentWillReceiveProps(nextProps) {
    if (this.props.hash != nextProps.hash) {
     const inputData = {
                     ...
                     errorType: nextProps.params.errorType
                    };

        console.log('ErrorDashboardDetails.js componentWillReceiveProps errorType ' + inputData.errorType)
  ...
  shouldComponentUpdate(nextProps, nextState){
    if(nextProps.refetch){
      const inputData = {
        ...
        console.log('ErrorDashboardDetails.js shouldComponentUpdate errorType ' + inputData.errorType)
         this.props.dispatch(getErrorDataList(inputData));
      return false;
    }
    return true;
    ...
    return (
      <div className="ui-content">
        ...
        {(this.props.params.lookup !== 'undefined' && (<h1>{this.props.params.lookup}</h1>))}
         ...
         <BootstrapTable data={errorData.result} striped={true} search={true} hover={true} exportCSV={true} pagination={true}>
              ...
              <i className="fa fa-spinner fa-spin" style={{fontSize:"100px", marginLeft: "50%", marginTop:"15%"}}></i>
          }
      </div>
    );
  }
