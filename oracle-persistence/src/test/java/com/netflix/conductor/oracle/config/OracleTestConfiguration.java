...
public class OracleTestConfiguration {
	...
	public OracleContainer oracleContainer() {
		...
		System.setProperty(OraclePersistenceTestConstants.ORACLE_JDBC_TIMEZONE_AS_REGION,OraclePersistenceTestConstants.FALSE);
    	System.setProperty(OraclePersistenceTestConstants.ORACLE_JDBC_FAN_ENABLED, OraclePersistenceTestConstants.FALSE);
    	...
    	OracleContainer oracleContainer = new OracleContainer(DockerImageName.parse(
  			 ...
  			 //OraclePersistenceTestConstants.ORAGE_DOCKER_IMAGE_18C_XE)); // To be enabled once Github Actions supports Oracle 18 XE based CICD
		oracleContainer
		.withStartupTimeoutSeconds(900)
		.withConnectTimeoutSeconds(900) 
		//.withPassword(OraclePersistenceTestConstants.STRONG_PASSWORD)  // To be enabled once Github Actions supports Oracle 18 XE based CICD
