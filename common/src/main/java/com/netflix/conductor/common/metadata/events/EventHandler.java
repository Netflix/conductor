...
public class EventHandler {
  ...
  /**
   * @param active
   *     if set to false, the event handler is deactivated
   */
  ...
  public static class Action {
    ...
    /**
     * @param start_workflow
     *     the start_workflow to set
     */
    ...
    /**
     * @param expandInlineJSON
     *     when set to true, the in-lined JSON strings are expanded to a full json document
     */
